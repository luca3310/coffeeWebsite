function Address() {
  return (
    ...
    >
      <div className="container flex rounded justify-between items-center flex-col ">
        <div className=" font-serif p-5 w-1/2 flex flex-col justify-center items-center  bg-black bg-opacity-50">
          <div>
